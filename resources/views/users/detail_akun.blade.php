...
<head>
    <meta charset="utf-8">
    <title>Detail Akun Anda | Orland</title>
...
<body>
    ...
    @php
        // use Carbon\Carbon;
        // $formattedDatetime = Carbon::createFromFormat('Y-m-d H:i:s', $data_akun->tanggal_lahir)->format('Y-m-d\TH:i');
    @endphp
        ...
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form method="POST" action="{{ route('user.update') }}">
                    ...
                    <div class="col-md-12 py-2">
                        <div class="form-group">
                            <label for="inputDateTime">Tanggal Lahir</label>
                            <input type="date" name="tanggal_lahir" class="form-control"
                                value="{{ date('Y-m-d', strtotime($data_akun->tanggal_lahir)) }}" id="inputDateTime">
                        </div>
                    </div>
